...
# 63cy = hele cypern
to_location = '94cy'
final_df = srape_flights('CPH', to_location, '2022-07-14')
csv_path = os.getcwd() + \
    "/exam-selenium-momondo-tester/exam-data/flight-scrape-single-5-maj-{to_location}.csv".format(to_location=to_location
)
